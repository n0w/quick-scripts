...
# Script para levantar un bridge l2 siguiendo el siguiente esquema
...
# Definimos el bridge
echo "[+] Definiendo bridge..."
brctl addbr br0
brctl addif br0 $BRif1
brctl addif br0 $BRif2

# Establecemos el forwarding y desactivamos el STP (para evitar STP spoofing)
echo "[+] Estableciendo forwarding..."
brctl setfd br0 0
echo "[+] Desactivando STP..."
brctl stp br0 off

# Levantamos el puente
echo "[+] Levantando el puente..."
ip link set $BRif1 up
ip link set $BRif2 up
ip link set br0 up
